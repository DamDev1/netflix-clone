...
export default function Movie({ movieItem, key }) {
    ...
    return (
        <div className='w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block cursor-pointer relative'>
            ...
            <div className='absolute top-0 left-0 w-full h-full hover:bg-black/80 opacity-0 hover:opacity-100 text-white'>
                ...
                <p onClick={savedShow}>
                    {like ? <FaHeart className='absolute top-4 left-4 text-gra-300'/> : <FaRegHeart className='absolute top-4 left-4 text-gra-300'/>}
                </p>
            </div>
